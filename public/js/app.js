...
(() => {
    ...
    async function loadBooks() {
        const hidden = getHiddenIds(HIDDEN_KEY);
    ...
    function renderRows(books) {
        ...
        tbody.innerHTML = books.map((book) => {
            ...
            let availableClass = 'text-success';
            if (availableStock === 0) availableClass = 'text-danger';
            else if (availableStock <= 2) availableClass = 'text-warning';
                ...
                <tr data-id="${book.id ?? ''}">
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            <button class="btn-edit btn btn-sm btn-outline-primary d-inline-flex align-items-center justify-content-center" data-id="${book.id ?? ''}" title="Edit">
                            ...
                            <a href="details.html?id=${encodeURIComponent(book.id)}" class="btn-view btn btn-sm btn-outline-info d-inline-flex align-items-center justify-content-center" title="View Details">
    ...
    btnDeleteSelected?.addEventListener('click', () => {
        ...
        setHiddenIds(HIDDEN_KEY, hidden);
        selectedIds.clear();
        loadBooks();
    });
