			...
			<tr data-id="${user.id ?? ''}">
				...
				<td>
					<div class="d-flex gap-1">
						...
						<a href="details-user.html?id=${encodeURIComponent(user.id)}" class="btn-view btn btn-sm btn-outline-info d-inline-flex align-items-center justify-content-center" data-id="${user.id ?? ''}" title="View Details" aria-label="View Details">
