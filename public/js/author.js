			...
			<tr data-id="${author.id ?? ''}">
				...
				<td>
					<div class="d-flex gap-1">
						...
						<a href="details-author.html?id=${encodeURIComponent(author.id)}" class="btn-view btn btn-sm btn-outline-info d-inline-flex align-items-center justify-content-center" data-id="${author.id ?? ''}" title="View Details" aria-label="View Details">
