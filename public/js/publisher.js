(() => {
      ...
      <tr data-id="${pub.id ?? ''}">
        ...
        <td>
          <div class="d-flex flex-column gap-1">
            ...
            <button class="btn-delete btn btn-sm btn-outline-danger d-inline-flex align-items-center justify-content-center" data-id="${pub.id ?? ''}" title="Delete" aria-label="Delete">
  ...
  tbody.addEventListener('click', (event) => {
    ...
    window.location.href = `update-publisher.html?id=${row.dataset.id}`;
  });
