(() => {
            ...
            <tr data-id="${pub.id ?? ''}">
                ...
                <td>
                    <div class="d-flex gap-1">
                        <button class="btn-edit btn btn-sm btn-outline-primary d-inline-flex align-items-center justify-content-center" data-id="${pub.id ?? ''}" title="Edit">
                        ...
                        <a href="details-publisher.html?id=${encodeURIComponent(pub.id)}" class="btn-view btn btn-sm btn-outline-info d-inline-flex align-items-center justify-content-center" title="View Details">
    ...
    btnAdd?.addEventListener('click', () => {
        window.location.href = 'create-publisher.html';
    });
